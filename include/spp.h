...
namespace spp{
  ...
  static node_t *buffer1, *buffer2;
  static answer_t ans1, ans2;
  ...
  void dijkstra(const GraphW &g, node_t s, answer_t &ans){
    auto &[dist, p] = ans;
  ...
  answer_t r_dijkstra(const GraphW &g, node_t s, node_t r, const answer_t &r_ans, const Graph &tr){
    auto &[dr, pr] = r_ans;
    auto &[ds, ps] = ans;
